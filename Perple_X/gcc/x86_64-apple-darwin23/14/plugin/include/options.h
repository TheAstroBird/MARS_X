...
#endif
#ifdef GENERATOR_FILE
extern int darwin_unreachable_traps;
#else
  int x_darwin_unreachable_traps;
#define darwin_unreachable_traps global_options.x_darwin_unreachable_traps
#endif
#ifdef GENERATOR_FILE
...
#define TARGET_MACHO_DYNAMIC_NO_PIC_OPTS_P(opts) (((opts->x_target_flags) & MASK_MACHO_DYNAMIC_NO_PIC) != 0)
...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 736,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 918,                               /* -Z */
  OPT_all_load = 919,                        /* -all_load */
  OPT_allowable_client = 920,                /* -allowable_client */
  OPT_ansi = 921,                            /* -ansi */
  OPT_arch = 922,                            /* -arch */
  OPT_arch_errors_fatal = 923,               /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 924,         /* -asm_macosx_version_min= */
  OPT_aux_info = 925,                        /* -aux-info */
  /* OPT_aux_info_ = 926, */                 /* -aux-info= */
  OPT_bind_at_load = 927,                    /* -bind_at_load */
  OPT_bundle = 928,                          /* -bundle */
  OPT_bundle_loader = 929,                   /* -bundle_loader */
  OPT_c = 930,                               /* -c */
  OPT_callgraph = 931,                       /* -callgraph */
  OPT_client_name = 932,                     /* -client_name */
  OPT_compatibility_version = 933,           /* -compatibility_version */
  OPT_coverage = 934,                        /* -coverage */
  OPT_cpp = 935,                             /* -cpp */
  OPT_cpp_ = 936,                            /* -cpp= */
  OPT_current_version = 937,                 /* -current_version */
  OPT_d = 938,                               /* -d */
  OPT_dead_strip = 939,                      /* -dead_strip */
  OPT_debuglib_ = 940,                       /* -debuglib= */
  OPT_defaultlib_ = 941,                     /* -defaultlib= */
  OPT_defined_only = 942,                    /* -defined-only */
  OPT_demangle = 943,                        /* -demangle */
  /* OPT_dependency_file = 944, */           /* -dependency-file */
  OPT_dstartfiles = 945,                     /* -dstartfiles */
  OPT_dump_body_ = 946,                      /* -dump-body= */
  OPT_dump_level_ = 947,                     /* -dump-level= */
  OPT_dumpbase = 948,                        /* -dumpbase */
  OPT_dumpbase_ext = 949,                    /* -dumpbase-ext */
  OPT_dumpdir = 950,                         /* -dumpdir */
  OPT_dumpfullversion = 951,                 /* -dumpfullversion */
  OPT_dumpmachine = 952,                     /* -dumpmachine */
  OPT_dumpspecs = 953,                       /* -dumpspecs */
  OPT_dumpversion = 954,                     /* -dumpversion */
  OPT_dylib_file = 955,                      /* -dylib_file */
  OPT_dylinker = 956,                        /* -dylinker */
  OPT_dylinker_install_name = 957,           /* -dylinker_install_name */
  OPT_dynamic = 958,                         /* -dynamic */
  OPT_dynamiclib = 959,                      /* -dynamiclib */
  OPT_e = 960,                               /* -e */
  OPT_export_dynamic = 961,                  /* -export-dynamic */
  OPT_exported_symbols_list = 962,           /* -exported_symbols_list */
  OPT_fPIC = 963,                            /* -fPIC */
  OPT_fPIE = 964,                            /* -fPIE */
  OPT_fRTS_ = 965,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 966,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 967,                   /* -fabi-version= */
  OPT_faccess_control = 968,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 969,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 970,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 971,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 972,                  /* -falign-commons */
  OPT_falign_functions = 973,                /* -falign-functions */
  OPT_falign_functions_ = 974,               /* -falign-functions= */
  OPT_falign_jumps = 975,                    /* -falign-jumps */
  OPT_falign_jumps_ = 976,                   /* -falign-jumps= */
  OPT_falign_labels = 977,                   /* -falign-labels */
  OPT_falign_labels_ = 978,                  /* -falign-labels= */
  OPT_falign_loops = 979,                    /* -falign-loops */
  OPT_falign_loops_ = 980,                   /* -falign-loops= */
  /* OPT_faligned_new = 981, */              /* -faligned-new */
  OPT_faligned_new_ = 982,                   /* -faligned-new= */
  OPT_fall_instantiations = 983,             /* -fall-instantiations */
  OPT_fall_intrinsics = 984,                 /* -fall-intrinsics */
  OPT_fall_virtual = 985,                    /* -fall-virtual */
  OPT_fallocation_dce = 986,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 987,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 988,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 989,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 990, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 991,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 992,         /* -falt-external-templates */
  OPT_fanalyzer = 993,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 994,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 995,              /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 996,        /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 997,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 998,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 999,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1000,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1001,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1002,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1003,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1004,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1005,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1006,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1007,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1008,           /* -fanalyzer-verbosity= */
  OPT_fapple_kext = 1009,                    /* -fapple-kext */
  /* OPT_fargument_alias = 1010, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1011, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1012, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1013, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1014,           /* -fasan-shadow-offset= */
  OPT_fasm = 1015,                           /* -fasm */
  OPT_fassert = 1016,                        /* -fassert */
  OPT_fassociative_math = 1017,              /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 1018,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1019,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1020,                     /* -fauto-init */
  OPT_fauto_profile = 1021,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1022,                 /* -fauto-profile= */
  OPT_fautomatic = 1023,                     /* -fautomatic */
  OPT_fbackslash = 1024,                     /* -fbackslash */
  OPT_fbacktrace = 1025,                     /* -fbacktrace */
  OPT_fbit_tests = 1026,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1027,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1028,                        /* -fbounds */
  OPT_fbounds_check = 1029,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1030,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1031,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1032,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1033, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1034, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1035, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1036,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1037,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1038,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1039,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1040,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1041,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1042,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1043,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1044,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1045,                    /* -fcall-used- */
  OPT_fcaller_saves = 1046,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1047,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1048,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1049,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1050,      /* -fcanonical-system-headers */
  OPT_fcase = 1051,                          /* -fcase */
  /* OPT_fcf_protection = 1052, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1053,                /* -fcf-protection= */
  OPT_fchar8_t = 1054,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1055,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1056, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1057,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1058,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1059,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1060, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1061, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1062, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1063, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1064, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1065, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1066,                  /* -fcheckaction= */
  OPT_fchecking = 1067,                      /* -fchecking */
  OPT_fchecking_ = 1068,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1069,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1070,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1071,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1072,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1073,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1074,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1075,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1076,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1077,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1078,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1079,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1080,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1081,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1082,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1083,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1084,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1085,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1086,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1087, */                /* -fcilkplus */
  OPT_fcoarray_ = 1088,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1089,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1090,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1091,                        /* -fcommon */
  OPT_fcompare_debug = 1092,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1093,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1094,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1095,                  /* -fcompare-elim */
  OPT_fconcepts = 1096,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1097,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1098,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1099,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1100,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1101, */          /* -fconserve-space */
  OPT_fconserve_stack = 1102,                /* -fconserve-stack */
  /* OPT_fconstant_cfstrings = 1103, */      /* -fconstant-cfstrings */
  OPT_fconstant_string_class_ = 1104,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1105,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1106,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1107,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1108,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1109,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1110,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1111,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1112,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1113,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1114,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1115,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1116, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1117,                     /* -fcontracts */
  OPT_fconvert_ = 1118,                      /* -fconvert= */
  OPT_fcoroutines = 1119,                    /* -fcoroutines */
  OPT_fcpp = 1120,                           /* -fcpp */
  OPT_fcpp_begin = 1121,                     /* -fcpp-begin */
  OPT_fcpp_end = 1122,                       /* -fcpp-end */
  OPT_fcprop_registers = 1123,               /* -fcprop-registers */
  OPT_fcray_pointer = 1124,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1125,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1126,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1127, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1128,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1129,              /* -fcx-limited-range */
  OPT_fd = 1130,                             /* -fd */
  OPT_fd_lines_as_code = 1131,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1132,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1133,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1134,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1135,                      /* -fdbg-cnt= */
  OPT_fdce = 1136,                           /* -fdce */
  OPT_fdebug = 1137,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1138,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1139,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1140,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1141,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1142,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1143,           /* -fdebug-types-section */
  OPT_fdebug_ = 1144,                        /* -fdebug= */
  OPT_fdec = 1145,                           /* -fdec */
  OPT_fdec_blank_format_item = 1146,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1147,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1148,           /* -fdec-format-defaults */
  OPT_fdec_include = 1149,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1150,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1151,                      /* -fdec-math */
  OPT_fdec_static = 1152,                    /* -fdec-static */
  OPT_fdec_structure = 1153,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1154,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1155, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1156,                          /* -fdef= */
  OPT_fdefault_double_8 = 1157,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1158, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1159,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1160,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1161,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1162,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1163,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1164,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1165,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1166,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1167,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1168,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1169,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1170,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1171,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1172,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_all_candidates = 1173,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1174, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1175,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1176,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1177,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1178,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1179,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1180,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1181,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1182,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1183,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1184,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1185,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1186,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1187,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1188,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1189, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1190,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1191,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1192,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1193,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1194,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1195, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1196,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1197,               /* -fdirectives-only */
  OPT_fdisable_ = 1198,                      /* -fdisable- */
  OPT_fdoc = 1199,                           /* -fdoc */
  OPT_fdoc_dir_ = 1200,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1201,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1202,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1203,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1204,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1205,                      /* -fdruntime */
  OPT_fdse = 1206,                           /* -fdse */
  OPT_fdump_ = 1207,                         /* -fdump- */
  OPT_fdump_ada_spec = 1208,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1209,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1210,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1211,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1212,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1213,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1214,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1215,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1216,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1217,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1218,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1219,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1220,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1221,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1222,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1223,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1224,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1225,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1226, */               /* -fdump-core */
  OPT_fdump_d_original = 1227,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1228,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1229,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1230,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1231,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1232,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1233,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1234,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1235,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1236, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1237,                   /* -fdump-passes */
  OPT_fdump_scos = 1238,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1239,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1240,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1241,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1242,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1243,                /* -fearly-inlining */
  OPT_felide_constructors = 1244,            /* -felide-constructors */
  OPT_felide_type = 1245,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1246, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1247,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1248,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1249,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1250,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1251,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1252,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1253,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1254,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1255,                /* -fenum-int-equiv */
  OPT_fexceptions = 1256,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1257,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1258,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1259,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1260,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1261,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1262,               /* -fextended-opaque */
  OPT_fextern_std_ = 1263,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1264,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1265,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1266,            /* -fexternal-templates */
  OPT_ff2c = 1267,                           /* -ff2c */
  OPT_ffast_math = 1268,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1269,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1270,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1271,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1272,              /* -ffinite-math-only */
  OPT_ffixed_ = 1273,                        /* -ffixed- */
  OPT_ffixed_form = 1274,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1275,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1276,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1277,                   /* -ffloat-store */
  OPT_ffloatvalue = 1278,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1279,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1280,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1281,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1282, */              /* -fforce-addr */
  OPT_fforward_propagate = 1283,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1284,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1285,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1286,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1287,                     /* -ffpe-trap= */
  OPT_ffree_form = 1288,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1289,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1290,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1291,                  /* -ffreestanding */
  OPT_ffriend_injection = 1292,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1293,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1294,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1295,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1296,             /* -ffunction-sections */
  OPT_fgcse = 1297,                          /* -fgcse */
  OPT_fgcse_after_reload = 1298,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1299,                      /* -fgcse-las */
  OPT_fgcse_lm = 1300,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1301,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1302,              /* -fgen-module-list= */
  OPT_fgimple = 1303,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1304,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1305,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1306,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1307,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1308,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1309,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1310,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1311,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1312,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1313,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1314,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1315,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1316,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1317,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1318,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1319,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1320,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1321,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1322,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1323,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1324,                      /* -fgraphite */
  OPT_fgraphite_identity = 1325,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1326,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1327,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1328, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1329,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1330, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1331, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1332,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1333,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1334,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1335,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1336,                      /* -fhardened */
  /* OPT_fhelp = 1337, */                    /* -fhelp */
  /* OPT_fhelp_ = 1338, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1339,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1340,                     /* -fhonor-std */
  OPT_fhosted = 1341,                        /* -fhosted */
  OPT_fhuge_objects = 1342,                  /* -fhuge-objects */
  OPT_fident = 1343,                         /* -fident */
  OPT_fif_conversion = 1344,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1345,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1346,        /* -fignore-unknown-pragmas */
  OPT_filelist = 1347,                       /* -filelist */
  OPT_fimmediate_escalation = 1348,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1349,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1350,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1351,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1352,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1353,            /* -fimplicit-templates */
  OPT_findex = 1354,                         /* -findex */
  OPT_findirect_inlining = 1355,             /* -findirect-inlining */
  OPT_findirect_virtual_calls = 1356,        /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 1357,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1358,               /* -finit-character= */
  OPT_finit_derived = 1359,                  /* -finit-derived */
  OPT_finit_integer_ = 1360,                 /* -finit-integer= */
  OPT_finit_local_zero = 1361,               /* -finit-local-zero */
  OPT_finit_logical_ = 1362,                 /* -finit-logical= */
  OPT_finit_real_ = 1363,                    /* -finit-real= */
  OPT_finline = 1364,                        /* -finline */
  OPT_finline_arg_packing = 1365,            /* -finline-arg-packing */
  OPT_finline_atomics = 1366,                /* -finline-atomics */
  OPT_finline_functions = 1367,              /* -finline-functions */
  OPT_finline_functions_called_once = 1368,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1369, */           /* -finline-limit- */
  OPT_finline_limit_ = 1370,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1371,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1372,        /* -finline-small-functions */
  OPT_finline_stringops = 1373,              /* -finline-stringops */
  OPT_finline_stringops_ = 1374,             /* -finline-stringops= */
  OPT_finput_charset_ = 1375,                /* -finput-charset= */
  OPT_finstrument_functions = 1376,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1377,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1378,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1379,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1380,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1381,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1382,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1383,                    /* -finvariants */
  OPT_fipa_bit_cp = 1384,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1385,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1386, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1387,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1388,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1389,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1390,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1391, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1392,                    /* -fipa-modref */
  OPT_fipa_profile = 1393,                   /* -fipa-profile */
  OPT_fipa_pta = 1394,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1395,                /* -fipa-pure-const */
  OPT_fipa_ra = 1396,                        /* -fipa-ra */
  OPT_fipa_reference = 1397,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1398,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1399,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1400,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1401,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1402, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1403,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1404,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1405,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1406,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1407,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1408,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1409,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1410,                  /* -fira-verbose= */
  OPT_fiso = 1411,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1412,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1413,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1414,              /* -fivar-visibility= */
  OPT_fivopts = 1415,                        /* -fivopts */
  OPT_fjump_tables = 1416,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1417,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1418,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1419,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1420,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1421,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1422,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1423,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1424,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1425,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1426,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1427,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1428,            /* -flarge-source-files */
  OPT_flat_namespace = 1429,                 /* -flat_namespace */
  OPT_flax_vector_conversions = 1430,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1431,            /* -fleading-underscore */
  OPT_flibs_ = 1432,                         /* -flibs= */
  OPT_flifetime_dse = 1433,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1434,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1435,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1436,                /* -flinker-output= */
  /* OPT_flive_patching = 1437, */           /* -flive-patching */
  OPT_flive_patching_ = 1438,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1439,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1440,                   /* -flocal-ivars */
  OPT_flocation_ = 1441,                     /* -flocation= */
  /* OPT_floop_block = 1442, */              /* -floop-block */
  /* OPT_floop_flatten = 1443, */            /* -floop-flatten */
  OPT_floop_interchange = 1444,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1445,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1446, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1447,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1448, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1449,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1450,                     /* -flra-remat */
  OPT_flto = 1451,                           /* -flto */
  OPT_flto_compression_level_ = 1452,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1453, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1454,                /* -flto-partition= */
  OPT_flto_report = 1455,                    /* -flto-report */
  OPT_flto_report_wpa = 1456,                /* -flto-report-wpa */
  OPT_flto_ = 1457,                          /* -flto= */
  OPT_fltrans = 1458,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1459,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1460,               /* -fm2-debug-trace= */
  OPT_fm2_g = 1461,                          /* -fm2-g */
  OPT_fm2_lower_case = 1462,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1463,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1464,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1465,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1466,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1467,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1468,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1469,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1470,             /* -fmacro-prefix-map= */
  OPT_fmain = 1471,                          /* -fmain */
  OPT_fmath_errno = 1472,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1473,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1474,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1475,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1476,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1477,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1478,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1479,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1480,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1481,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1482,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1483,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1484,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1485,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1486,                          /* -fmod= */
  OPT_fmodule_file_ = 1487,                  /* -fmodule-file= */
  OPT_fmodule_header = 1488,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1489,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1490,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1491,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1492,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1493,                   /* -fmodule-only */
  OPT_fmodule_private = 1494,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1495,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1496,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1497,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1498,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1499,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1500,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1501,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1502,                 /* -fms-extensions */
  OPT_fmudflap = 1503,                       /* -fmudflap */
  OPT_fmudflapir = 1504,                     /* -fmudflapir */
  OPT_fmudflapth = 1505,                     /* -fmudflapth */
  OPT_fmultiflags = 1506,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1507,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1508,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1509,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1510,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1511,                  /* -fnext-runtime */
  OPT_fnil = 1512,                           /* -fnil */
  OPT_fnil_receivers = 1513,                 /* -fnil-receivers */
  OPT_fno_inline_stringops = 1514,           /* -fno-inline-stringops */
  OPT_fno_modules = 1515,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1516,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1517,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1518,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1519,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1520,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1521,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1522,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1523,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1524,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1525,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1526,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1527,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1528,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1529,              /* -foffload-options= */
  OPT_foffload_ = 1530,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1531,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1532,                         /* -fonly= */
  OPT_fopenacc = 1533,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1534,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1535,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1536,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1537,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1538, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1539,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1540,                /* -foperator-names */
  OPT_fopt_info = 1541,                      /* -fopt-info */
  OPT_fopt_info_ = 1542,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1543, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1544,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1545,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1546, */          /* -foptional-diags */
  OPT_force_cpusubtype_ALL = 1547,           /* -force_cpusubtype_ALL */
  OPT_force_flat_namespace = 1548,           /* -force_flat_namespace */
  OPT_fpack_derived = 1549,                  /* -fpack-derived */
  OPT_fpack_struct = 1550,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1551,                  /* -fpack-struct= */
  OPT_fpad_source = 1552,                    /* -fpad-source */
  OPT_fpartial_inlining = 1553,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1554,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1555,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1556,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1557,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1558,                    /* -fpeel-loops */
  OPT_fpeephole = 1559,                      /* -fpeephole */
  OPT_fpeephole2 = 1560,                     /* -fpeephole2 */
  OPT_fpermissive = 1561,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1562,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1563,                           /* -fpic */
  OPT_fpie = 1564,                           /* -fpie */
  OPT_fpim = 1565,                           /* -fpim */
  OPT_fpim2 = 1566,                          /* -fpim2 */
  OPT_fpim3 = 1567,                          /* -fpim3 */
  OPT_fpim4 = 1568,                          /* -fpim4 */
  OPT_fplan9_extensions = 1569,              /* -fplan9-extensions */
  OPT_fplt = 1570,                           /* -fplt */
  OPT_fplugin_arg_ = 1571,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1572,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1573,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1574,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1575,                /* -fpostconditions */
  OPT_fpre_include_ = 1576,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1577,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1578,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1579,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1580,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1581,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1582,              /* -fpretty-templates */
  OPT_fpreview_all = 1583,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1584,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1585,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1586,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1587,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1588,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1589,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1590,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1591,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1592,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1593,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1594,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1595,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1596,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1597,           /* -fprintf-return-value */
  OPT_fprofile = 1598,                       /* -fprofile */
  OPT_fprofile_abs_path = 1599,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1600,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1601,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1602,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1603,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1604,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1605,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1606,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1607,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1608,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1609,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1610,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1611,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1612,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1613,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1614,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1615,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1616,               /* -fprofile-update= */
  OPT_fprofile_use = 1617,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1618,                  /* -fprofile-use= */
  OPT_fprofile_values = 1619,                /* -fprofile-values */
  OPT_fprotect_parens = 1620,                /* -fprotect-parens */
  OPT_fpthread = 1621,                       /* -fpthread */
  OPT_fq = 1622,                             /* -fq */
  OPT_framework = 1623,                      /* -framework */
  OPT_frandom_seed = 1624,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1625,                  /* -frandom-seed= */
  OPT_frange = 1626,                         /* -frange */
  OPT_frange_check = 1627,                   /* -frange-check */
  OPT_freal_4_real_10 = 1628,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1629,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1630,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1631,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1632,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1633,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1634,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1635,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1636,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1637,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1638,               /* -frecord-marker=8 */
  OPT_frecursive = 1639,                     /* -frecursive */
  OPT_free = 1640,                           /* -free */
  OPT_freg_struct_return = 1641,             /* -freg-struct-return */
  /* OPT_fregmove = 1642, */                 /* -fregmove */
  OPT_frelease = 1643,                       /* -frelease */
  OPT_frename_registers = 1644,              /* -frename-registers */
  OPT_freorder_blocks = 1645,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1646,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1647,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1648,             /* -freorder-functions */
  OPT_frepack_arrays = 1649,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1650,          /* -freplace-objc-classes */
  OPT_frepo = 1651,                          /* -frepo */
  OPT_freport_bug = 1652,                    /* -freport-bug */
  OPT_frequire_return_statement = 1653,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1654,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1655, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1656,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1657,                   /* -fresolution= */
  OPT_freturn = 1658,                        /* -freturn */
  OPT_frevert_all = 1659,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1660,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1661,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1662,             /* -frevert=intpromote */
  OPT_frounding_math = 1663,                 /* -frounding-math */
  OPT_frtti = 1664,                          /* -frtti */
  OPT_fruntime_modules_ = 1665,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1666,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1667,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1668,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1669,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1670,                   /* -frust-crate= */
  OPT_frust_debug = 1671,                    /* -frust-debug */
  OPT_frust_dump_ = 1672,                    /* -frust-dump- */
  OPT_frust_edition_ = 1673,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1674,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1675,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1676,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1677,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1678,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1679,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1680,      /* -frust-name-resolution-2.0 */
  OPT_fsanitize_address_use_after_scope = 1681,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1682,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1683,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1684,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1685,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1686,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1687,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1688, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1689,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1690,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1691,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1692,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1693,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1694,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1695,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1696,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1697, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1698,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1699,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1700,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1701,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1702,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1703,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1704,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1705,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1706,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1707,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1708,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1709,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1710,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1711,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1712,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1713,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1714, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1715,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1716,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1717,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1718,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1719,               /* -fsection-anchors */
  /* OPT_fsee = 1720, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1721,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1722,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1723,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1724,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1725,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1726,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1727,        /* -fsemantic-interposition */
  OPT_fshared = 1728,                        /* -fshared */
  OPT_fshort_enums = 1729,                   /* -fshort-enums */
  OPT_fshort_wchar = 1730,                   /* -fshort-wchar */
  OPT_fshow_column = 1731,                   /* -fshow-column */
  OPT_fshrink_wrap = 1732,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1733,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1734,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1735,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1736,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1737,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1738,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1739,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1740,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1741,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1742,                /* -fsoft-check-all */
  OPT_fsources = 1743,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1744,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1745,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1746,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1747,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1748,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1749,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1750,                      /* -fsquangle */
  OPT_fssa_backprop = 1751,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1752,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1753,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1754,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1755, */             /* -fstack-check */
  OPT_fstack_check_ = 1756,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1757,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1758,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1759,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1760,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1761,               /* -fstack-protector */
  OPT_fstack_protector_all = 1762,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1763,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1764,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1765,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1766,                   /* -fstack-usage */
  OPT_fstack_use_cumulative_args = 1767,     /* -fstack-use-cumulative-args */
  OPT_fstats = 1768,                         /* -fstats */
  OPT_fstdarg_opt = 1769,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1770,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1771, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1772,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1773,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1774, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1775,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1776,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1777,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1778,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1779, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1780,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1781,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1782,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1783,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1784,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1785,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1786,                  /* -fstrub=strict */
  OPT_fswig = 1787,                          /* -fswig */
  OPT_fswitch_errors = 1788,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1789,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1790,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1791,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1792, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1793,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1794, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1795,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1796, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1797,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1798,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1799,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1800,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1801,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1802,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1803,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1804,                   /* -ftime-report */
  OPT_ftime_report_details = 1805,           /* -ftime-report-details */
  OPT_ftls_model_ = 1806,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1807,              /* -ftoplevel-reorder */
  OPT_ftracer = 1808,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1809,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1810,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1811,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1812,                   /* -ftrampolines */
  OPT_ftransition_all = 1813,                /* -ftransition=all */
  OPT_ftransition_field = 1814,              /* -ftransition=field */
  OPT_ftransition_in = 1815,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1816,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1817,          /* -ftransition=templates */
  OPT_ftransition_tls = 1818,                /* -ftransition=tls */
  OPT_ftrapping_math = 1819,                 /* -ftrapping-math */
  OPT_ftrapv = 1820,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1821,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1822,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1823,                      /* -ftree-ccp */
  OPT_ftree_ch = 1824,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1825, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1826,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1827,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1828, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1829,                   /* -ftree-cselim */
  OPT_ftree_dce = 1830,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1831,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1832,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1833,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1834,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1835, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1836,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1837,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1838, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1839,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1840,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1841, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1842,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1843,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1844,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1845,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1846,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1847,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1848,                      /* -ftree-pre */
  OPT_ftree_pta = 1849,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1850,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1851, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1852,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1853,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1854,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1855,                     /* -ftree-slsr */
  OPT_ftree_sra = 1856,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1857, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1858, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1859,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1860,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1861,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1862, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1863,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1864, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1865,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1866,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1867,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1868,         /* -funconstrained-commons */
  OPT_funderscoring = 1869,                  /* -funderscoring */
  OPT_funit_at_a_time = 1870,                /* -funit-at-a-time */
  OPT_funittest = 1871,                      /* -funittest */
  OPT_funreachable_traps = 1872,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1873,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1874,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1875,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1876, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1877,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1878,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1879,                 /* -funsigned-char */
  OPT_funswitch_loops = 1880,                /* -funswitch-loops */
  OPT_funwind_tables = 1881,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1882,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1883,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1884,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1885,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1886,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1887,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1888,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1889,                     /* -fuse-list= */
  OPT_fvar_tracking = 1890,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1891,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1892,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1893,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1894,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1895, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1896,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1897,                   /* -fverbose-asm */
  /* OPT_fversion = 1898, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1899,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1900,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1901,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1902,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1903,                   /* -fvisibility= */
  OPT_fvpt = 1904,                           /* -fvpt */
  OPT_fvtable_gc = 1905,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1906,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1907,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1908,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1909,                     /* -fvtv-debug */
  OPT_fweak = 1910,                          /* -fweak */
  OPT_fweak_templates = 1911,                /* -fweak-templates */
  OPT_fweb = 1912,                           /* -fweb */
  /* OPT_fwhole_file = 1913, */              /* -fwhole-file */
  OPT_fwhole_program = 1914,                 /* -fwhole-program */
  OPT_fwholediv = 1915,                      /* -fwholediv */
  OPT_fwholevalue = 1916,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1917,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1918,             /* -fworking-directory */
  OPT_fwpa = 1919,                           /* -fwpa */
  OPT_fwpa_ = 1920,                          /* -fwpa= */
  OPT_fwrapv = 1921,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1922,                 /* -fwrapv-pointer */
  OPT_fxref = 1923,                          /* -fxref */
  /* OPT_fzee = 1924, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1925,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1926,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1927,                     /* -fzero-link */
  OPT_g = 1928,                              /* -g */
  OPT_gant = 1929,                           /* -gant */
  OPT_gas_loc_support = 1930,                /* -gas-loc-support */
  OPT_gas_locview_support = 1931,            /* -gas-locview-support */
  OPT_gbtf = 1932,                           /* -gbtf */
  OPT_gcodeview = 1933,                      /* -gcodeview */
  OPT_gcoff = 1934,                          /* -gcoff */
  OPT_gcoff1 = 1935,                         /* -gcoff1 */
  OPT_gcoff2 = 1936,                         /* -gcoff2 */
  OPT_gcoff3 = 1937,                         /* -gcoff3 */
  OPT_gcolumn_info = 1938,                   /* -gcolumn-info */
  OPT_gctf = 1939,                           /* -gctf */
  OPT_gdescribe_dies = 1940,                 /* -gdescribe-dies */
  OPT_gdwarf = 1941,                         /* -gdwarf */
  OPT_gdwarf_ = 1942,                        /* -gdwarf- */
  OPT_gdwarf32 = 1943,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1944,                       /* -gdwarf64 */
  OPT_gen_decls = 1945,                      /* -gen-decls */
  OPT_gfull = 1946,                          /* -gfull */
  OPT_ggdb = 1947,                           /* -ggdb */
  OPT_ggnu_pubnames = 1948,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1949,                   /* -gimple-stats */
  OPT_ginline_points = 1950,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1951, /* -ginternal-reset-location-views */
  OPT_gnat = 1952,                           /* -gnat */
  OPT_gnatO = 1953,                          /* -gnatO */
  OPT_gno_ = 1954,                           /* -gno- */
  OPT_gno_pubnames = 1955,                   /* -gno-pubnames */
  OPT_gpubnames = 1956,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1957,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1958,                   /* -gsplit-dwarf */
  OPT_gstabs = 1959,                         /* -gstabs */
  OPT_gstabs_ = 1960,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1961,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1962,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1963,                        /* -gtoggle */
  OPT_gused = 1964,                          /* -gused */
  OPT_gvariable_location_views = 1965,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1966,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1967,                           /* -gvms */
  OPT_gxcoff = 1968,                         /* -gxcoff */
  OPT_gxcoff_ = 1969,                        /* -gxcoff+ */
  OPT_gz = 1970,                             /* -gz */
  OPT_gz_ = 1971,                            /* -gz= */
  OPT_h = 1972,                              /* -h */
  OPT_headerpad_max_install_names = 1973,    /* -headerpad_max_install_names */
  OPT_help = 1974,                           /* -help */
  OPT_idirafter = 1975,                      /* -idirafter */
  OPT_iframework = 1976,                     /* -iframework */
  OPT_imacros = 1977,                        /* -imacros */
  OPT_image_base = 1978,                     /* -image_base */
  OPT_imultiarch = 1979,                     /* -imultiarch */
  OPT_imultilib = 1980,                      /* -imultilib */
  OPT_include = 1981,                        /* -include */
  OPT_init = 1982,                           /* -init */
  OPT_install_name = 1983,                   /* -install_name */
  OPT_iplugindir_ = 1984,                    /* -iplugindir= */
  OPT_iprefix = 1985,                        /* -iprefix */
  OPT_iquote = 1986,                         /* -iquote */
  OPT_isysroot = 1987,                       /* -isysroot */
  OPT_isystem = 1988,                        /* -isystem */
  OPT_iwithprefix = 1989,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1990,              /* -iwithprefixbefore */
  OPT_k8 = 1991,                             /* -k8 */
  OPT_keep_private_externs = 1992,           /* -keep_private_externs */
  OPT_l = 1993,                              /* -l */
  OPT_lang_asm = 1994,                       /* -lang-asm */
  OPT_list = 1995,                           /* -list */
  OPT_m128bit_long_double = 1996,            /* -m128bit-long-double */
  OPT_m16 = 1997,                            /* -m16 */
  OPT_m32 = 1998,                            /* -m32 */
  OPT_m3dnow = 1999,                         /* -m3dnow */
  OPT_m3dnowa = 2000,                        /* -m3dnowa */
  OPT_m64 = 2001,                            /* -m64 */
  OPT_m80387 = 2002,                         /* -m80387 */
  OPT_m8bit_idiv = 2003,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 2004,             /* -m96bit-long-double */
  OPT_mabi_ = 2005,                          /* -mabi= */
  OPT_mabm = 2006,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 2007,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 2008,                 /* -maddress-mode= */
  OPT_madx = 2009,                           /* -madx */
  OPT_maes = 2010,                           /* -maes */
  OPT_malign_data_ = 2011,                   /* -malign-data= */
  OPT_malign_double = 2012,                  /* -malign-double */
  OPT_malign_functions_ = 2013,              /* -malign-functions= */
  OPT_malign_jumps_ = 2014,                  /* -malign-jumps= */
  OPT_malign_loops_ = 2015,                  /* -malign-loops= */
  OPT_malign_stringops = 2016,               /* -malign-stringops */
  OPT_mamx_bf16 = 2017,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2018,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2019,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 2020,                      /* -mamx-int8 */
  OPT_mamx_tile = 2021,                      /* -mamx-tile */
  OPT_mapx_features_ = 2022,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2023,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2024,                          /* -mapxf */
  OPT_march_ = 2025,                         /* -march= */
  OPT_masm_ = 2026,                          /* -masm= */
  OPT_matt_stubs = 2027,                     /* -matt-stubs */
  OPT_mavx = 2028,                           /* -mavx */
  /* OPT_mavx10_1 = 2029, */                 /* -mavx10.1 */
  OPT_mavx10_1_256 = 2030,                   /* -mavx10.1-256 */
  OPT_mavx10_1_512 = 2031,                   /* -mavx10.1-512 */
  OPT_mavx2 = 2032,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2033,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2034,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 2035,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 2036,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 2037,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2038,                  /* -mavx512bitalg */
  OPT_mavx512bw = 2039,                      /* -mavx512bw */
  OPT_mavx512cd = 2040,                      /* -mavx512cd */
  OPT_mavx512dq = 2041,                      /* -mavx512dq */
  OPT_mavx512er = 2042,                      /* -mavx512er */
  OPT_mavx512f = 2043,                       /* -mavx512f */
  OPT_mavx512fp16 = 2044,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2045,                    /* -mavx512ifma */
  OPT_mavx512pf = 2046,                      /* -mavx512pf */
  OPT_mavx512vbmi = 2047,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2048,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2049,                      /* -mavx512vl */
  OPT_mavx512vnni = 2050,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2051,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2052,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2053,                       /* -mavxifma */
  OPT_mavxneconvert = 2054,                  /* -mavxneconvert */
  OPT_mavxvnni = 2055,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2056,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2057,                   /* -mavxvnniint8 */
  OPT_mbmi = 2058,                           /* -mbmi */
  OPT_mbmi2 = 2059,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2060,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2061,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2062,                    /* -mcet-switch */
  OPT_mcld = 2063,                           /* -mcld */
  OPT_mcldemote = 2064,                      /* -mcldemote */
  OPT_mclflushopt = 2065,                    /* -mclflushopt */
  OPT_mclwb = 2066,                          /* -mclwb */
  OPT_mclzero = 2067,                        /* -mclzero */
  OPT_mcmodel_ = 2068,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2069,                     /* -mcmpccxadd */
  OPT_mconstant_cfstrings = 2070,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 2071, */                    /* -mcpu= */
  OPT_mcrc32 = 2072,                         /* -mcrc32 */
  OPT_mcx16 = 2073,                          /* -mcx16 */
  OPT_mdaz_ftz = 2074,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2075,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2076,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2077,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 2078,                /* -mdynamic-no-pic */
  OPT_menqcmd = 2079,                        /* -menqcmd */
  OPT_mevex512 = 2080,                       /* -mevex512 */
  OPT_mf16c = 2081,                          /* -mf16c */
  OPT_mfancy_math_387 = 2082,                /* -mfancy-math-387 */
  OPT_mfentry = 2083,                        /* -mfentry */
  OPT_mfentry_name_ = 2084,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2085,               /* -mfentry-section= */
  OPT_mfix_and_continue = 2086,              /* -mfix-and-continue */
  OPT_mfma = 2087,                           /* -mfma */
  OPT_mfma4 = 2088,                          /* -mfma4 */
  OPT_mforce_drap = 2089,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2090,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2091,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2092,                       /* -mfpmath= */
  OPT_mfsgsbase = 2093,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2094,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2095, */              /* -mfused-madd */
  OPT_mfxsr = 2096,                          /* -mfxsr */
  /* OPT_mgather = 2097, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2098,             /* -mgeneral-regs-only */
  OPT_mgfni = 2099,                          /* -mgfni */
  OPT_mhard_float = 2100,                    /* -mhard-float */
  OPT_mharden_sls_ = 2101,                   /* -mharden-sls= */
  OPT_mhle = 2102,                           /* -mhle */
  OPT_mhreset = 2103,                        /* -mhreset */
  OPT_miamcu = 2104,                         /* -miamcu */
  OPT_mieee_fp = 2105,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2106,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2107,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2108,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2109,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2110,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2111,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2112,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2113, */            /* -mintel-syntax */
  OPT_mkernel = 2114,                        /* -mkernel */
  OPT_mkl = 2115,                            /* -mkl */
  OPT_mlam_ = 2116,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2117,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2118,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2119,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2120,                /* -mlong-double-80 */
  OPT_mlwp = 2121,                           /* -mlwp */
  OPT_mlzcnt = 2122,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 2123,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 2124,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2125,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2126,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2127,                  /* -mmitigate-rop */
  OPT_mmmx = 2128,                           /* -mmmx */
  OPT_mmovbe = 2129,                         /* -mmovbe */
  OPT_mmovdir64b = 2130,                     /* -mmovdir64b */
  OPT_mmovdiri = 2131,                       /* -mmovdiri */
  OPT_mmove_max_ = 2132,                     /* -mmove-max= */
  OPT_mmpx = 2133,                           /* -mmpx */
  OPT_mms_bitfields = 2134,                  /* -mms-bitfields */
  OPT_mmwait = 2135,                         /* -mmwait */
  OPT_mmwaitx = 2136,                        /* -mmwaitx */
  OPT_mneeded = 2137,                        /* -mneeded */
  OPT_mno_align_stringops = 2138,            /* -mno-align-stringops */
  OPT_mno_default = 2139,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2140,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2141,                  /* -mno-push-args */
  OPT_mno_red_zone = 2142,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2143,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2144,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2145,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2146,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 2147,                 /* -mone-byte-bool */
  OPT_mpartial_vector_fp_math = 2148,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2149,                          /* -mpc32 */
  OPT_mpc64 = 2150,                          /* -mpc64 */
  OPT_mpc80 = 2151,                          /* -mpc80 */
  OPT_mpclmul = 2152,                        /* -mpclmul */
  OPT_mpcommit = 2153,                       /* -mpcommit */
  OPT_mpconfig = 2154,                       /* -mpconfig */
  OPT_mpku = 2155,                           /* -mpku */
  OPT_mpopcnt = 2156,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2157, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2158,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2159,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2160,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2161,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2162,                        /* -mprfchw */
  OPT_mptwrite = 2163,                       /* -mptwrite */
  OPT_mpush_args = 2164,                     /* -mpush-args */
  OPT_mraoint = 2165,                        /* -mraoint */
  OPT_mrdpid = 2166,                         /* -mrdpid */
  OPT_mrdrnd = 2167,                         /* -mrdrnd */
  OPT_mrdseed = 2168,                        /* -mrdseed */
  OPT_mrecip = 2169,                         /* -mrecip */
  OPT_mrecip_ = 2170,                        /* -mrecip= */
  OPT_mrecord_mcount = 2171,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2172,                 /* -mrecord-return */
  OPT_mred_zone = 2173,                      /* -mred-zone */
  OPT_mregparm_ = 2174,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2175,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2176,                           /* -mrtd */
  OPT_mrtm = 2177,                           /* -mrtm */
  OPT_msahf = 2178,                          /* -msahf */
  /* OPT_mscatter = 2179, */                 /* -mscatter */
  OPT_mserialize = 2180,                     /* -mserialize */
  OPT_msgx = 2181,                           /* -msgx */
  OPT_msha = 2182,                           /* -msha */
  OPT_msha512 = 2183,                        /* -msha512 */
  OPT_mshstk = 2184,                         /* -mshstk */
  OPT_mskip_rax_setup = 2185,                /* -mskip-rax-setup */
  OPT_msm3 = 2186,                           /* -msm3 */
  OPT_msm4 = 2187,                           /* -msm4 */
  OPT_msoft_float = 2188,                    /* -msoft-float */
  OPT_msse = 2189,                           /* -msse */
  OPT_msse2 = 2190,                          /* -msse2 */
  OPT_msse2avx = 2191,                       /* -msse2avx */
  OPT_msse3 = 2192,                          /* -msse3 */
  OPT_msse4 = 2193,                          /* -msse4 */
  OPT_msse4_1 = 2194,                        /* -msse4.1 */
  OPT_msse4_2 = 2195,                        /* -msse4.2 */
  OPT_msse4a = 2196,                         /* -msse4a */
  /* OPT_msse5 = 2197, */                    /* -msse5 */
  OPT_msseregparm = 2198,                    /* -msseregparm */
  OPT_mssse3 = 2199,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2200,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 2203, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2204,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2205,                  /* -mstackrealign */
  OPT_mstore_max_ = 2206,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2207,            /* -mstringop-strategy= */
  OPT_mstv = 2208,                           /* -mstv */
  OPT_msymbol_stubs = 2209,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 2210,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 2211, */          /* -mtarget-linker= */
  OPT_mtbm = 2212,                           /* -mtbm */
  OPT_mtls_dialect_ = 2213,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2214,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2215,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2216,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2217,                         /* -mtune= */
  OPT_muintr = 2218,                         /* -muintr */
  OPT_multi_module = 2219,                   /* -multi_module */
  OPT_multiply_defined = 2220,               /* -multiply_defined */
  OPT_multiply_defined_unused = 2221,        /* -multiply_defined_unused */
  OPT_munreachable_traps = 2222,             /* -munreachable-traps */
  OPT_munroll_only_small_loops = 2223,       /* -munroll-only-small-loops */
  OPT_musermsr = 2224,                       /* -musermsr */
  OPT_mvaes = 2225,                          /* -mvaes */
  OPT_mveclibabi_ = 2226,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2227,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2228,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2229,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2230,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2231,                      /* -mwbnoinvd */
  OPT_mwidekl = 2232,                        /* -mwidekl */
  OPT_mx32 = 2233,                           /* -mx32 */
  OPT_mxop = 2234,                           /* -mxop */
  OPT_mxsave = 2235,                         /* -mxsave */
  OPT_mxsavec = 2236,                        /* -mxsavec */
  OPT_mxsaveopt = 2237,                      /* -mxsaveopt */
  OPT_mxsaves = 2238,                        /* -mxsaves */
  OPT_n = 2239,                              /* -n */
  OPT_name_sort = 2240,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2241,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2242,              /* -no-integrated-cpp */
  OPT_no_pie = 2243,                         /* -no-pie */
  OPT_no_dead_strip_inits_and_terms = 2244,  /* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 2245,                          /* -nocpp */
  OPT_nodefaultexport = 2246,                /* -nodefaultexport */
  OPT_nodefaultlibs = 2247,                  /* -nodefaultlibs */
  OPT_nodefaultrpaths = 2248,                /* -nodefaultrpaths */
  OPT_nofixprebinding = 2249,                /* -nofixprebinding */
  OPT_nolibc = 2250,                         /* -nolibc */
  OPT_nomultidefs = 2251,                    /* -nomultidefs */
  OPT_nophoboslib = 2252,                    /* -nophoboslib */
  OPT_noprebind = 2253,                      /* -noprebind */
  OPT_noseglinkedit = 2254,                  /* -noseglinkedit */
  OPT_nostartfiles = 2255,                   /* -nostartfiles */
  OPT_nostdinc = 2256,                       /* -nostdinc */
  OPT_nostdinc__ = 2257,                     /* -nostdinc++ */
  OPT_nostdlib = 2258,                       /* -nostdlib */
  OPT_nostdlib__ = 2259,                     /* -nostdlib++ */
  OPT_o = 2260,                              /* -o */
  OPT_object = 2261,                         /* -object */
  OPT_objects = 2262,                        /* -objects */
  OPT_p = 2263,                              /* -p */
  OPT_pagezero_size = 2264,                  /* -pagezero_size */
  OPT_pass_exit_codes = 2265,                /* -pass-exit-codes */
  /* OPT_pedantic = 2266, */                 /* -pedantic */
  OPT_pedantic_errors = 2267,                /* -pedantic-errors */
  OPT_pg = 2268,                             /* -pg */
  OPT_pie = 2269,                            /* -pie */
  OPT_pipe = 2270,                           /* -pipe */
  OPT_prebind = 2271,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 2272,   /* -prebind_all_twolevel_modules */
  OPT_preload = 2273,                        /* -preload */
  OPT_print_file_name_ = 2274,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2275,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2276,          /* -print-multi-directory */
  OPT_print_multi_lib = 2277,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2278,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2279,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2280,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2281,               /* -print-prog-name= */
  OPT_print_search_dirs = 2282,              /* -print-search-dirs */
  OPT_print_sysroot = 2283,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2284,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2285,                    /* -print-value */
  OPT_private_bundle = 2286,                 /* -private_bundle */
  OPT_pthread = 2287,                        /* -pthread */
  OPT_quiet = 2288,                          /* -quiet */
  OPT_r = 2289,                              /* -r */
  OPT_rdynamic = 2290,                       /* -rdynamic */
  OPT_read_only_relocs = 2291,               /* -read_only_relocs */
  OPT_remap = 2292,                          /* -remap */
  OPT_reverse_sort = 2293,                   /* -reverse-sort */
  OPT_rpath = 2294,                          /* -rpath */
  OPT_s = 2295,                              /* -s */
  OPT_save_temps = 2296,                     /* -save-temps */
  OPT_save_temps_ = 2297,                    /* -save-temps= */
  OPT_sectalign = 2298,                      /* -sectalign */
  OPT_sectcreate = 2299,                     /* -sectcreate */
  OPT_sectobjectsymbols = 2300,              /* -sectobjectsymbols */
  OPT_sectorder = 2301,                      /* -sectorder */
  OPT_seg1addr = 2302,                       /* -seg1addr */
  OPT_seg_addr_table = 2303,                 /* -seg_addr_table */
  OPT_seg_addr_table_filename = 2304,        /* -seg_addr_table_filename */
  OPT_segaddr = 2305,                        /* -segaddr */
  OPT_segcreate = 2306,                      /* -segcreate */
  OPT_seglinkedit = 2307,                    /* -seglinkedit */
  OPT_segprot = 2308,                        /* -segprot */
  OPT_segs_read_only_addr = 2309,            /* -segs_read_only_addr */
  OPT_segs_read_write_addr = 2310,           /* -segs_read_write_addr */
  OPT_shared = 2311,                         /* -shared */
  OPT_shared_libgcc = 2312,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2313,               /* -shared-libphobos */
  OPT_single_module = 2314,                  /* -single_module */
  OPT_size_sort = 2315,                      /* -size-sort */
  /* OPT_specs = 2316, */                    /* -specs */
  OPT_specs_ = 2317,                         /* -specs= */
  OPT_static = 2318,                         /* -static */
  OPT_static_libasan = 2319,                 /* -static-libasan */
  OPT_static_libgcc = 2320,                  /* -static-libgcc */
  OPT_static_libgfortran = 2321,             /* -static-libgfortran */
  OPT_static_libgm2 = 2322,                  /* -static-libgm2 */
  OPT_static_libgo = 2323,                   /* -static-libgo */
  OPT_static_libhwasan = 2324,               /* -static-libhwasan */
  OPT_static_liblsan = 2325,                 /* -static-liblsan */
  OPT_static_libmpx = 2326,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2327,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2328,               /* -static-libphobos */
  OPT_static_libquadmath = 2329,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2330,               /* -static-libstdc++ */
  OPT_static_libtsan = 2331,                 /* -static-libtsan */
  OPT_static_libubsan = 2332,                /* -static-libubsan */
  OPT_static_pie = 2333,                     /* -static-pie */
  /* OPT_std_c__03 = 2334, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2335, */                /* -std=c++0x */
  OPT_std_c__11 = 2336,                      /* -std=c++11 */
  OPT_std_c__14 = 2337,                      /* -std=c++14 */
  OPT_std_c__17 = 2338,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2339, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2340, */                /* -std=c++1z */
  OPT_std_c__20 = 2341,                      /* -std=c++20 */
  OPT_std_c__23 = 2342,                      /* -std=c++23 */
  OPT_std_c__26 = 2343,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2344, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2345, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2346, */                /* -std=c++2c */
  OPT_std_c__98 = 2347,                      /* -std=c++98 */
  OPT_std_c11 = 2348,                        /* -std=c11 */
  OPT_std_c17 = 2349,                        /* -std=c17 */
  /* OPT_std_c18 = 2350, */                  /* -std=c18 */
  /* OPT_std_c1x = 2351, */                  /* -std=c1x */
  OPT_std_c23 = 2352,                        /* -std=c23 */
  /* OPT_std_c2x = 2353, */                  /* -std=c2x */
  /* OPT_std_c89 = 2354, */                  /* -std=c89 */
  OPT_std_c90 = 2355,                        /* -std=c90 */
  OPT_std_c99 = 2356,                        /* -std=c99 */
  /* OPT_std_c9x = 2357, */                  /* -std=c9x */
  OPT_std_f2003 = 2358,                      /* -std=f2003 */
  OPT_std_f2008 = 2359,                      /* -std=f2008 */
  OPT_std_f2008ts = 2360,                    /* -std=f2008ts */
  OPT_std_f2018 = 2361,                      /* -std=f2018 */
  OPT_std_f2023 = 2362,                      /* -std=f2023 */
  OPT_std_f95 = 2363,                        /* -std=f95 */
  OPT_std_gnu = 2364,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2365, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2366, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2367,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2368,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2369,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2370, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2371, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2372,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2373,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2374,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2375, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2376, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2377, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2378,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2379,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2380,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2381, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2382, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2383,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2384, */                /* -std=gnu2x */
  /* OPT_std_gnu89 = 2385, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2386,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2387,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2388, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2389, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2390,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2391, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2392, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2393, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2394, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2395, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2396, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2397,                     /* -std=legacy */
  OPT_stdlib_ = 2398,                        /* -stdlib= */
  OPT_sub_library = 2399,                    /* -sub_library */
  OPT_sub_umbrella = 2400,                   /* -sub_umbrella */
  OPT_symbol_ = 2401,                        /* -symbol= */
  OPT_symbolic = 2402,                       /* -symbolic */
  OPT_t = 2403,                              /* -t */
  OPT_time = 2404,                           /* -time */
  OPT_time_ = 2405,                          /* -time= */
  OPT_traditional = 2406,                    /* -traditional */
  OPT_traditional_cpp = 2407,                /* -traditional-cpp */
  OPT_tree_stats = 2408,                     /* -tree-stats */
  OPT_trigraphs = 2409,                      /* -trigraphs */
  OPT_twolevel_namespace = 2410,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2411,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2412,                     /* -type-stats */
  OPT_u = 2413,                              /* -u */
  OPT_umbrella = 2414,                       /* -umbrella */
  OPT_undef = 2415,                          /* -undef */
  OPT_undefined = 2416,                      /* -undefined */
  OPT_unexported_symbols_list = 2417,        /* -unexported_symbols_list */
  OPT_v = 2418,                              /* -v */
  OPT_version = 2419,                        /* -version */
  OPT_w = 2420,                              /* -w */
  OPT_weak_reference_mismatches = 2421,      /* -weak_reference_mismatches */
  OPT_whatsloaded = 2422,                    /* -whatsloaded */
  OPT_whyload = 2423,                        /* -whyload */
